...
func init() {
	...
	beego.GlobalControllerRouter["Odontologia/controllers:ControlPlacaController"] = append(beego.GlobalControllerRouter["Odontologia/controllers:ControlPlacaController"],
		beego.ControllerComments{
			Method:           "Post",
			Router:           "/",
			AllowHTTPMethods: []string{"post"},
